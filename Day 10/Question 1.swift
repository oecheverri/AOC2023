...
func findNextStep(from coords: (x: Int, y: Int), lastdirection direction: inout Direction) -> (x: Int, y: Int) {
...
func findStartTileType(coords: (x: Int, y: Int)) -> Tile {
...
print(map[startCoordinates.y].tiles[startCoordinates.x])
...
repeat {
    ...
    steps += 1
    print("Travelled: \(lastDirection)\tto: \(currentCoordinates)")
